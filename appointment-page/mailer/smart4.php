...
$mail->Username = 'department-boychuka@eko3dkt.com.ua';                 // Наш логин
$mail->Password = '135678eko3dkt';                           // Наш пароль от ящика
$mail->SMTPSecure = 'TLS';                            // Enable TLS encryption, `ssl` also accepted
$mail->Port = 587;                                    // TCP port to connect to
 
$mail->setFrom('department-boychuka@eko3dkt.com.ua', 'Website EKO 3D KT');   // От кого письмо 
$mail->addAddress('0671413566dn@gmail.com');     // Add a recipient
