...
$mail->Username = 'department-malinovskogo@eko3dkt.com.ua';                 // Наш логин
$mail->Password = '135678eko3dkt';                           // Наш пароль от ящика
$mail->SMTPSecure = 'TLS';                            // Enable TLS encryption, `ssl` also accepted
$mail->Port = 587;                                    // TCP port to connect to
 
$mail->setFrom('department-malinovskogo@eko3dkt.com.ua', 'Website EKO 3D KT');   // От кого письмо 
$mail->addAddress('0674006897M@gmail.com');     // Add a recipient
