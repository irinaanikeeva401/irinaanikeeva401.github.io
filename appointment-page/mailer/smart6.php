...
$mail->Username = 'department-krakovskaya@eko3dkt.com.ua';                 // Наш логин
$mail->Password = '135678eko3dkt';                           // Наш пароль от ящика
$mail->SMTPSecure = 'TLS';                            // Enable TLS encryption, `ssl` also accepted
$mail->Port = 587;                                    // TCP port to connect to
 
$mail->setFrom('department-krakovskaya@eko3dkt.com.ua', 'Website EKO 3D KT');   // От кого письмо 
$mail->addAddress('krakovska3dkt@gmail.com');     // Add a recipient
